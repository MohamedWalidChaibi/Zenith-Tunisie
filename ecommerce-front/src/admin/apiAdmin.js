...
/* pour effectuer CRUD sur les produits
 * obtenir tous les produits
 * obtenir un seul produit
 * mettre à jour un seul produit
...
/* pour effectuer CRUD sur les utilisateurs
...
export const adminUpdate = (userId, token, user) => {
        return fetch(`${API}/admin/user/${userId}`, {
            method: "PUT",
            headers: {
                Accept: "application/json",
...
export const adminUpdateUser = (user, next) => {
